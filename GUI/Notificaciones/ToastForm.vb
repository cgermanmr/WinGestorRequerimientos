...
#Region "Propiedades"
    ...
    Public Property JobNotificacion() As Requerimiento
        Get
            Return _job
        End Get
...
#Region " Constructors "
    ...
    ''' </param>
    Public Sub New(ByVal lifeTime As Integer, ByVal job As Requerimiento)
        ...
        Me.JobNotificacion = job
        Me.Text = String.Format("{0} - {1}", job.JobId, job.Proceso)
        Me.messageLabel.Text = job.Descripcion
...
#Region " Event Handlers "
    ...
    Private Sub ToastForm_DoubleClick(sender As Object, e As EventArgs) Handles Me.DoubleClick
        VisorJob()
    End Sub
...
#End Region 'Event Handlers
    ...
    Private Sub VisorJob()
        Dim formVisor As New frmVisor()
        formVisor.JobVisor = Me.JobNotificacion
        formVisor.Show()
        Me.Close()
    End Sub
